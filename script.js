...
function updateLanguage() {
  ...
  if (isChinese) {
    ...
    if (document.getElementById("nav-home"))
      document.getElementById("nav-home").innerText = "首頁";
    if (document.getElementById("nav-about"))
      document.getElementById("nav-about").innerText = "關於我們";
    if (document.getElementById("nav-parent"))
      document.getElementById("nav-parent").innerText = "家長資源";
    if (document.getElementById("nav-contact"))
      document.getElementById("nav-contact").innerText = "聯絡我們";
    ...
    if (document.getElementById("footer-hours-label"))
      document.getElementById("footer-hours-label").innerText = "營業時間:";
    if (document.getElementById("footer-links-title"))
      document.getElementById("footer-links-title").innerText = "快速連結";
    if (document.getElementById("foot-link-home"))
      document.getElementById("foot-link-home").innerText = "首頁";
    if (document.getElementById("foot-link-about"))
      document.getElementById("foot-link-about").innerText = "關於我們";
    if (document.getElementById("foot-link-parent"))
      document.getElementById("foot-link-parent").innerText = "家長資源";
    if (document.getElementById("foot-link-contact"))
      document.getElementById("foot-link-contact").innerText = "聯絡我們";

    // --- 3. INDEX PAGE SPECIFIC ---
    if (document.getElementById("hero-title")) {
      document.getElementById("hero-title").innerHTML =
        "<span class='accent-text'>歡迎來到</span> <br><span class='highlight'>Rainbow D.Y.E</span> <br><span class='accent-text'>小彩虹學院</span>";
      document.getElementById("hero-desc").innerText =
        "在這裡，每個孩子都是點亮和啟發世界的色彩。";
    ...
    if (document.getElementById("school-title")) {
      ...
      document.getElementById("content-meals").innerHTML =
        "提供午餐和兩次點心<br>配合過敏需求。<br><a href='documents/Septembermeal.pdf' class='grid-link' id='link-meal'>查看每月菜單</a>";
    }
    ...
    if (document.getElementById("values-title")) {
      ...
      document.getElementById("val-1-desc").innerText =
        "透過有趣的語言探索，我們幫助孩子自然發展雙語能力，開啟通往文化連結的大門。";
      document.getElementById("val-2-title").innerText = "音樂啟蒙";
      document.getElementById("val-2-desc").innerText =
        "我們利用音樂來培養創造力和自我表達以及對節奏，旋律與律動的熱愛";
      document.getElementById("val-3-title").innerText = "社交情感學習";
      document.getElementById("val-3-desc").innerText =
        "我們引導孩子發展同理心、溝通技巧和自我意識，建立有意義的人際關係。";
      document.getElementById("val-4-title").innerText = "彩虹樂趣";
      document.getElementById("val-4-desc").innerText =
        "每一天都充滿多采多姿的活動。從手工到戶外娛樂，讓學習充滿孩子們的創意和愉悅。";
    }

    // --- 4. ABOUT PAGE SPECIFIC ---
    if (document.getElementById("about-header-title")) {
      document.getElementById("about-header-title").innerText =
        "我們的故事與理念";
      document.getElementById("about-header-desc").innerText =
        "了解 Rainbow D.Y.E 的核心精神、靈魂與安全承諾。";
      ...
      document.getElementById("about-curr-title").innerHTML =
        "<i class='fas fa-book-open'></i> 我們的課程";
      document.getElementById("about-curr-desc").innerText =
        "看看我們的每日作息表。";
      document.getElementById("about-curr-btn").innerHTML =
        "<i class='fas fa-download'></i> 下載課程表";

      document.getElementById("about-safety-title").innerText = "安全與環境";
      document.getElementById("about-safety-subtitle").innerText =
        "我們透過嚴格的安全協議和安全的環境，將每個孩子的福祉放在首位。";

      document.getElementById("safe-1-title").innerText = "安全接送";
      document.getElementById("safe-1-desc").innerText =
        "孩子僅交由經過身份驗證的父母或授權人員接回。";
      document.getElementById("safe-2-title").innerText = "健康協議";
      document.getElementById("safe-2-desc").innerText =
        "我們為等待接回的身體不適兒童提供有人看管的安靜空間。";
      document.getElementById("safe-3-title").innerText = "用藥安全";
      document.getElementById("safe-3-desc").innerText =
        "我們要求醫生處方、原始包裝和簽署的表格，以確保絕對安全。";
      document.getElementById("safe-4-title").innerText = "過敏意識";
      document.getElementById("safe-4-desc").innerText =
        "入學時建立詳細的過敏應急計劃，以確保用餐安全。";

      document.getElementById("nutri-title").innerHTML =
        "<i class='fas fa-utensils'></i> 健康營養";
      document.getElementById("nutri-intro").innerText =
        "我們相信健康的身體能激發健康的心靈。我們每天提供三頓營養餐點，融合了亞洲和西方家庭式烹飪的均衡搭配。";

      document.getElementById("nutri-li-1").innerHTML =
        "<strong><i class='fas fa-apple-alt'></i> 多樣化菜單:</strong> 最受歡迎的包括洋蔥雞肉炒飯、豬肉水餃、滷肉飯、義大利麵和迷你漢堡。";
      document.getElementById("nutri-li-2").innerHTML =
        "<strong><i class='fas fa-baby'></i> 嬰兒護理:</strong> 為兩歲以下兒童提供特製餐點，如南瓜粥、雞肉粥或蔬菜粥。";
      document.getElementById("nutri-li-3").innerHTML =
        "<strong><i class='fas fa-leaf'></i> 新鮮健康:</strong> 點心包括時令水果、牛奶、麵包和優格。";
      document.getElementById("nutri-li-4").innerHTML =
        "<strong><i class='fas fa-carrot'></i> 特別活動:</strong> 每週二的「素食日」以及偶爾為孩子舉辦的烹飪課！";
    }
    ...
    if (document.getElementById("contact-header-title")) {
      ...
      document.getElementById("contact-header-desc").innerText =
        "我們很希望能見到您！請填寫以下表格以了解更多課程資訊或預約參觀。";
      ...
      document.getElementById("info-days").innerText =
        "週一 - 週五: 8:00 AM - 6:00 PM";
    ...
    if (document.getElementById("parent-header-title")) {
      ...
      document.getElementById("parent-header-desc").innerText =
        "隨時掌握我們的每月活動、菜單和重要文件。";

      document.getElementById("calendar-title").innerText = "學校行事曆";
      document.getElementById("calendar-desc").innerText =
        "在此查看假期、拍照日和特別活動。";
    ...
    if (document.getElementById("nav-parent"))
      document.getElementById("nav-parent").innerText = "Parent Resources";
    if (document.getElementById("nav-contact"))
    ...
    if (document.getElementById("footer-contact-title"))
      document.getElementById("footer-contact-title").innerText =
        "Contact Info";
    if (document.getElementById("footer-hours-label"))
      document.getElementById("footer-hours-label").innerText = "Hours:";
    if (document.getElementById("footer-links-title"))
      document.getElementById("footer-links-title").innerText = "Quick Links";
    if (document.getElementById("foot-link-home"))
      document.getElementById("foot-link-home").innerText = "Home";
    if (document.getElementById("foot-link-about"))
      document.getElementById("foot-link-about").innerText = "About Us";
    if (document.getElementById("foot-link-parent"))
      document.getElementById("foot-link-parent").innerText =
        "Parent Resources";
    if (document.getElementById("foot-link-contact"))
      document.getElementById("foot-link-contact").innerText = "Contact Us";

    // --- 3. INDEX PAGE SPECIFIC ---
    if (document.getElementById("hero-title")) {
      document.getElementById("hero-title").innerHTML =
        "<span class='accent-text'>Welcome to</span> <br><span class='highlight'>Rainbow D.Y.E</span> <br><span class='accent-text'>Home Care</span>";
      document.getElementById("hero-desc").innerText =
        "Where every child becomes a color that brightens and inspires the world.";
    ...
    if (document.getElementById("school-title")) {
      ...
      document.getElementById("content-ages").innerText =
        "Newborn - 6 years old";
      ...
      document.getElementById("content-meals").innerHTML =
        "2 Snack Breaks and Lunch.<br>Allergies Accommodated.<br><a href='documents/Septembermeal.pdf' class='grid-link' id='link-meal' target='_blank'>View Monthly Meal Plan</a>";
    }
    if (document.getElementById("phil-quote")) {
      document.getElementById("phil-quote").innerText =
    ...
    if (document.getElementById("values-title")) {
      ...
      document.getElementById("val-1-desc").innerText =
        "Through playful language exploration we help children develop bilingual skills naturally, opening doors to a world of cultural connection.";
      document.getElementById("val-2-title").innerText = "Music Enlightenment";
      document.getElementById("val-2-desc").innerText =
        "We use the universal language of music to nurture creativity and self-expression, fostering a love for rhythm, melody, and movement.";
      document.getElementById("val-3-title").innerText =
        "Social-Emotional Learning";
      document.getElementById("val-3-desc").innerText =
        "We guide children in developing empathy, communication skills, and self-awareness to build meaningful relationships.";
      document.getElementById("val-4-title").innerText = "Rainbow Fun";
      document.getElementById("val-4-desc").innerText =
        "Every day is filled with colorful activities. From crafts to outdoor play, we make learning creative and pure joy.";
    }
    ...
    if (document.getElementById("about-header-title")) {
      ...
      document.getElementById("about-header-desc").innerText =
        "Get to know the heart, soul, and safety behind Rainbow D.Y.E.";
      ...
      document.getElementById("about-yuri-role").innerText =
        "Director & Lead Teacher";

      document.getElementById("about-curr-title").innerHTML =
        "<i class='fas fa-book-open'></i> Our Curriculum";
      document.getElementById("about-curr-desc").innerText =
        "Take a peek into our daily schedule.";
      document.getElementById("about-curr-btn").innerHTML =
        "<i class='fas fa-download'></i> Download Schedule";

      document.getElementById("about-safety-title").innerText =
        "Safety & Environment";
      document.getElementById("about-safety-subtitle").innerText =
        "We prioritize the well-being of every child through strict safety protocols and a secure environment.";

      document.getElementById("safe-1-title").innerText = "Secure Pick-Up";
      document.getElementById("safe-1-desc").innerText =
        "Children are only released to verified parents or authorized individuals with ID checks.";
      document.getElementById("safe-2-title").innerText = "Health Protocols";
      document.getElementById("safe-2-desc").innerText =
        "We provide a supervised quiet space for children who feel unwell while waiting for pickup.";
      document.getElementById("safe-3-title").innerText = "Medication Safety";
      document.getElementById("safe-3-desc").innerText =
        "We require doctor’s prescriptions, original packaging, and signed forms for absolute safety.";
      document.getElementById("safe-4-title").innerText = "Allergy Awareness";
      document.getElementById("safe-4-desc").innerText =
        "Detailed allergy contingency plans are established upon enrollment for safe dining.";

      document.getElementById("nutri-title").innerHTML =
        "<i class='fas fa-utensils'></i> Wholesome Nutrition";
      document.getElementById("nutri-intro").innerText =
        "We believe that a healthy body fuels a healthy mind. We provide three nutritious meals daily featuring a balanced mix of Asian and Western home-style cooking.";

      document.getElementById("nutri-li-1").innerHTML =
        "<strong><i class='fas fa-apple-alt'></i> Diverse Menu:</strong> Favorites include chicken & onion stir-fry, pork dumplings, braised meat, pasta, and mini-burgers.";
      document.getElementById("nutri-li-2").innerHTML =
        "<strong><i class='fas fa-baby'></i> Infant Care:</strong> Specialized meals like pumpkin, chicken, or vegetable porridge for those under two.";
      document.getElementById("nutri-li-3").innerHTML =
        "<strong><i class='fas fa-leaf'></i> Fresh & Wholesome:</strong> Snacks include seasonal fruits, milk, bread, and yogurt.";
      document.getElementById("nutri-li-4").innerHTML =
        "<strong><i class='fas fa-carrot'></i> Special Events:</strong> \"Vege Day\" every Tuesday and occasional cooking classes for the kids!";
    }
    ...
    if (document.getElementById("contact-header-title")) {
      ...
      document.getElementById("contact-header-desc").innerText =
        "We'd love to meet you! Fill out the form below to learn more about our programs or schedule a visit.";
      ...
      document.getElementById("parentName").placeholder =
      ...
      document.getElementById("label-msg").innerText =
    ...
    // --- 6. PARENT RESOURCES PAGE SPECIFIC (NEW) ---
    if (document.getElementById("parent-header-title")) {
      document.getElementById("parent-header-title").innerText =
        "Parent Portal";
      document.getElementById("parent-header-desc").innerText =
        "Stay updated with our monthly events, menus, and important documents.";

      document.getElementById("calendar-title").innerText = "School Calendar";
      document.getElementById("calendar-desc").innerText =
        "Check here for holidays, picture days, and special events.";
      ...
      document.getElementById("handbook-desc").innerText =
        "Read about our policies, philosophy, and daily routines.";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  contactForm.addEventListener("submit", function (event) {
    ...
    if (!dobInput || !dobFormattedInput) {
      console.error(
        "❌ Error: Missing DOB input or the hidden 'childDobFormatted' input in your HTML.",
      );
