  ...
  if (isChinese) {
    ...
    if (document.getElementById("school-title")) {
      ...
      document.getElementById("content-meals").innerHTML =
        "提供午餐和兩次點心<br>配合過敏需求。<br><a href='documents/julymeal.pdf' class='grid-link' id='link-meal'>查看每月菜單</a>";
    }
    ...
    if (document.getElementById("school-title")) {
      ...
      document.getElementById("content-meals").innerHTML =
        "2 Snack Breaks and Lunch.<br>Allergies Accommodated.<br><a href='documents/julymeal.pdf' class='grid-link' id='link-meal' target='_blank'>View Monthly Meal Plan</a>";
    }
    if (document.getElementById("phil-quote")) {
      document.getElementById("phil-quote").innerText =
